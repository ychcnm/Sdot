        ...
        <div class="content">
            <div class="container-fluid" id="lotrow">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                    <div class="card mb-3">
                        <div class="card-header" id="createLotHead">
                                                ...
                                                <div class="card-body">
                                                    <form>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <small id="prdSeriesHelp" class="form-text text-muted">
                                                                Please
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" class="form-control  is-valid"
                                                                   id="prdQty"
                                                                   aria-describedby="prdQtyHelp"
                                                                   placeholder="Enter number"
                                                                   required="required" min="0">
                                                            <small id="prdQtyHelp" class="form-text text-muted">Please
                                                                Input
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    <div class="row" id="processBar">
                                        ...
                                        <button id="clearLot" role="button" class="btn btn-secondary" href="#"
                                                type="button">Clear
                                        </button>
                                    </div>
                                </div>
